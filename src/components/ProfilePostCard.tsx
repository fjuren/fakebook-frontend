...
export default function ProfilePostCard({ post, user }: any) {
  ...
  return (
    <Card sx={{ maxWidth: 345 }}>
      <CardHeader
        avatar={
          <CustomAvatar avatarURL={user.avatar} userFirstnameLetter={user.firstName.substring(0, 1)} sx={{ bgcolor: red[500] }}></CustomAvatar>
        }
        action={
